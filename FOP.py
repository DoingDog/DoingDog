# modded DD , original https://github.com/AdguardTeam/AdguardFilters/blob/master/FOP.py
# modded line 62-64 81 305-308 372-374 496
...
IGNORE = (
    "CC-BY-SA.txt", "easytest.txt", "GPL.txt", "MPL.txt", "filter.txt", "exclusions.txt", "general_extensions.txt", "rule-list.ini", "deletion.dd", "w.tmxt",
    "antiadblock.txt", "foreign.txt", "whitelist.txt", "general_js_api.txt", "whitelist_stealth.txt", "addition.dd", "title.dd",
    "enhancedstats-addon.txt", "fanboy-tracking", "firefox-regional", "other", "custom-rules")
